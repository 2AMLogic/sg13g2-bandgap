...
# Preflight: this testbench instantiates real PSP103 MOS and r3_cmc resistor
# devices, so it is worthless without the OSDI models. Fail here with an
# actionable message rather than producing 45 log files full of
