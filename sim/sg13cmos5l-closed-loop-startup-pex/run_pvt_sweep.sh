...

{
  ...
  echo "  support is currently broken, klayout-tools#1440; bipolar devices"
  echo "  are still schematic-sourced, not extracted -- klayout-tools#1242."
  echo "  Resistor devices ARE now extracted as of issue #176/#173's"
  echo "  poly-resistor fold, klayout-tools#1415 -- still spliced verbatim"
  echo "  below regardless, see README.md for why). No ratified spec row"
  echo "  exists yet for SG13CMOS5L (spec/porting-plan-sg13cmos5l.md, \"Status: engineering"
  ...
  echo "  not recognise bipolar devices (klayout-tools#1242). It DOES now"
  echo "  recognise rppd/rhigh as of issue #176/#173's fold"
  echo "  (klayout-tools#1415), but XR1/XR2/XRPU stay schematic-sourced --"
  echo "  see README.md for why. XRPU (rhigh) spliced verbatim from"
